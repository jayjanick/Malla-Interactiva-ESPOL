...
export function TermsOfService() {
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -20 }}
      className="max-w-4xl mx-auto w-full bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/10 rounded-2xl p-6 md:p-12 shadow-xl"
    >
      <div className="flex items-center gap-4 mb-8 border-b border-slate-300 dark:border-white/10 pb-6">
        <div className="p-3 bg-indigo-500/10 rounded-xl text-indigo-400">
          <FileText className="w-8 h-8" />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Términos y Condiciones de Uso</h1>
          <p className="text-slate-500 dark:text-white/50 mt-1">Última actualización: {new Date().toLocaleDateString()}</p>
        </div>
      </div>

      <div className="space-y-8 text-slate-600 dark:text-white/70 leading-relaxed">
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">1. Aceptación de los Términos</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">2. Exención de Responsabilidad (No Oficial)</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">3. Uso de la Aplicación</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">4. Limitaciones</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">5. Publicidad (Google AdSense)</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">6. Modificaciones</h2>
          <p>
