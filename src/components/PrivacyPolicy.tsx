  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-8 border-b border-slate-300 dark:border-white/10 pb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Políticas de Privacidad</h1>
      ...
      <div className="space-y-8 text-slate-600 dark:text-white/70 leading-relaxed">
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">1. Información que recopilamos</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">2. Uso de Cookies y Publicidad (Google AdSense)</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">3. Analíticas Web</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">4. Enlaces a terceros</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">5. Consentimiento</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">6. Contacto</h2>
          <p>
