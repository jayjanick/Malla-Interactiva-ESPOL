  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-emerald-500/30 flex">
      ...
      <div className="flex-1 flex flex-col relative z-10 min-h-screen pb-24 md:pb-0">
        ...
        <footer className="w-full text-center py-6 text-[11px] text-white/30 relative z-10 mt-auto">
          © {new Date().getFullYear()} - Hecho con ❤️ por <a href="https://github.com/jayjanick" target="_blank" rel="noopener noreferrer" className="hover:text-white/50 transition-colors">Jay</a>
        </footer>
